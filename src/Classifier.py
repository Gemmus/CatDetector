...
class Classifier():
    ...
    def set_defaults(self):
        ...
        self.model_weights_path = './models_yolov4tiny/yolov4-tiny.weights'
        self.model_config_path = './models_yolov4tiny/yolov4-tiny.cfg'
        #self.model_weights_path = './models_yolov3/yolov3.weights'
        #self.model_config_path = './models_yolov3/yolov3.cfg'
    ...
    def load_labels(self):
        ...
        labels_path = './models_yolov4tiny/coco.names'
        #labels_path = './models_yolov3/coco_names'
